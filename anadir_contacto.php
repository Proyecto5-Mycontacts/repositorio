...
<body>
  ...
  ?> 
   ...
   <li> <label for="surname">Apellido:</label> <input type="text" name="apellido" placeholder="Apellido contacto" required /> </li>
    <li> <label for="telefono">Telefono:</label> <input type="text" name="telefono" placeholder="Num. Telefono" required /> </li>
    ...
    <li><input type="date" name="cumpleanios" step="1" min="1900-01-01"  value="<?php echo date("Y-m-d");?>"><span class="form_hint"> Formato correcto: "aaaa/mm/dd"</span> </li> 
  <li><input id="foto" type="file" ></li>

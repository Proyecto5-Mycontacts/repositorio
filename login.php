...
<body id="page-top" class="index">
    ...
    <form name="Login" action="login.proc.php" onsubmit="return validar();">
            ...
            Usuario:<input type="text" class="form-control" id="nombre" name="nombre" placeholder="usuario" onfocus="document.Login.nombre.style.color='';"><br>
            Contraseña:<input type="password" class="form-control" name="password" placeholder="contraseña" onfocus="document.Login.password.style.color='';"/><br>
            </div>
            <div class="col-md-3 text-center"><br><br>
              <button class="page-scroll btn btn-xl">Entrar</button><br>
              ¿No tienes cuenta?<a href="alta_usuario.php" > Registrate.</a>
            </div>
            <div class="col-md-3 text-center">
            </div>
